                    ...
                    <div id="nav-dropdown">
                        ...
                        <div className="collapse navbar-collapse" id="navbarScroll">
                            <ul className="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" >
                                ...
                                <li className="nav-item">
                                    <a className="nav-link" onClick={() => handlePageChange('Works')} href="#my-works">Projects</a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link" onClick={() => handlePageChange('Resume')} href="#my-resume">Resume</a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link" onClick={() => handlePageChange('Contact')} href="#contact-me">Hire Me</a>
                                </li>
                            </ul>
                        </div>
                    </div>

                    <a className="navbar-brand" onClick={() => handlePageChange('About')} href="#About"> <h2>Zhong Zheng</h2></a>
